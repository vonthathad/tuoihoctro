...
class ImagePrettyLoad extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <div className={`${st.placeholder}`} style={{ width, height: this.containerWidth * imageHeight / imageWidth }} ref={(container) => { if (container) this.containerWidth = container.offsetWidth; }}>
                    <div>
